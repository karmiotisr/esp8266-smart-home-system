...
BLYNK_WRITE(VPIN_BUTTON_5) {   //Virtual pin on Blynk app 
    ...
    digitalWrite( RelayPin5, toggleState_0);
    digitalWrite( RelayPin7, toggleState_0);
    ...
    Blynk.virtualWrite(VPIN_BUTTON_6, toggleState_0);
    Blynk.virtualWrite(VPIN_BUTTON_7, toggleState_0);
}
